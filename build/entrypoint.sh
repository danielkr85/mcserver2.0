...
MIN_MEMORY="${MIN_MEMORY:-$1}"
MAX_MEMORY="${MAX_MEMORY:-$2}"
WORLD_DIR="${WORLD_DIR:-$3}"
shift 3
ADDITIONAL_ARGS="$@"

JAR_FILE="/mcserver/server.jar"
...
CMD="java -Xms${MIN_MEMORY} -Xmx${MAX_MEMORY} -jar $JAR_FILE --world ./worlds/$WORLD_DIR $ADDITIONAL_ARGS"
echo "Executing: $CMD"
exec $CMD
